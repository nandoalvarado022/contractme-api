...
export class PropertyController {
  ...
  create(@Body() createPropertyDto: CreatePropertyDto, @UserId() uid: number) {
    return this.propertyService.create(createPropertyDto, uid);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Soft deletes a property listing. The property can be restored later.',
  })
  @ApiParam({ name: 'id', description: 'Property ID', type: Number })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({ status: 404, description: 'Property not found' })
  @ResponseMessage('Propiedad eliminada exitosamente')
  ...
  @ApiOperation({
    ...
    description: 'Restores a previously soft-deleted property',
  })
  @ApiParam({ name: 'id', description: 'Property ID', type: Number })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({ status: 404, description: 'Property not found' })
  @ResponseMessage('Propiedad restaurada exitosamente')
  restore(@Param('id', ParseIntPipe) id: number) {
    return this.propertyService.restore(id);
  }
